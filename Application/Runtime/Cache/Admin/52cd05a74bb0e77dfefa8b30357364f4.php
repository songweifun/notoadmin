...
<div class="container" ng-app="myApps" ng-controller="myCtrl">
    <div class="row">
        ...
        <div class="totol " style=" float:right;">
                ...
                <?php if($orderList != null): if(is_array($orderList)): foreach($orderList as $key=>$orderList): ?><tr class="result_list">
                    ...
                    <td class="choose_td" align="center">
                        <div style="min-width: 80px;">
                            <?php if($orderList['status'] < 3): ?><a href="javascript:;" class="btn btn-primary btn-sm operation" data-id="<?php echo ($orderList['id']); ?>" data-state="3">审核通过</a>
                            <?php elseif($orderList['status'] == 3): ?>
                                <a href="javascript:;" class="btn btn-primary btn-sm operation" data-id="<?php echo ($orderList['id']); ?>" data-state="4">发件</a>
                            <?php elseif($orderList['status'] == 4): ?>
                                已发件<?php endif; ?>
                        </div>
                    </td>
            ...
            <button type="button" class="btn btn-primary btn-sm" id="getValue" data-toggle="modal" data-target="#myModal">审核</button>
